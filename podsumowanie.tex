...
Mój wkład w projekt:
\begin{itemize}
    \item \textbf{Projekt i implementacja architektury:} Zaprojektowałam oraz zaprogramowałam klasę planszy.
...
Pracowałem nad generowaniem i obsługą planszy podczas rozgrywki. Zaprojektowałem oraz zaimplementowałem klasę plansza i metody obsługujące ruchy gracza, generowanie planszy oraz rozpoczęcie/zakończenie rozgrywki.
