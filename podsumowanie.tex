...
\begin{itemize}
    \item \textbf{Komunikacja z użytkownikiem:} Opracowanie funkcji pobierających dane od użytkownika podczas tworzenia konta i logowania oraz przekazujących te dane do modułów napisanych przez Zuzannę Żol.
    \item \textbf{Ranking:} Implementacja funkcji \texttt{wyswietl\_ranking()}, prezentującej najlepsze wyniki zalogowanych użytkowników (na podstawie danych zapisanych przez funkcje Zuzanny Żol).
    \item \textbf{Pozostałe:} Integracja funkcji wczytywania gry, usuwania konta oraz zapisywania stanu gry.
\end{itemize}
